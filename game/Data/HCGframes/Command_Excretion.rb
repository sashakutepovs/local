p "Playing HCGframe : Command_Excretion.rb"
...
if $game_player.actor.urinary_level + $game_player.actor.defecate_level < 600
	$game_message.add("\\t[commonCommands:Lona/Excretion_end_NoExcretion]")
...
call_msg("commonCommands:Lona/Bath_begin3_FuckerSight#{talk_style}") if $game_player.actor.stat["Exhibitionism"] != 1
call_msg("commonCommands:Lona/Bath_begin3_FuckerSight_slut") if $game_player.actor.stat["Exhibitionism"] == 1
	$game_map.interpreter.wait_for_message
...
load_script("Data/HCGframes/Command_Pee.rb") if $game_player.actor.urinary_level >=300
load_script("Data/HCGframes/Command_Poo.rb") if $game_player.actor.defecate_level >=300
