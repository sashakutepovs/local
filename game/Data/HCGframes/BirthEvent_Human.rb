...
################################################################
$game_player.actor.stat["EventVag"] ="Human_Birth0"
$game_player.actor.stat["vagopen"] =0
...
########################################################################frame 1###################################################################################################
$game_player.actor.stat["EventVag"] = "Human_Birth1"
...
################################################################
$game_player.actor.stat["EventVag"] ="Human_Birth2"
$game_player.actor.stat["vagopen"] =1
...
################################################################
$game_player.actor.stat["EventVag"] ="Human_Birth3"
$game_player.actor.stat["vagopen"] =1
$game_player.actor.stat["preg"] -=1 if $game_player.actor.stat["preg"] !=0 #preg
...
$game_map.reserve_summon_event("PlayerHumanBaby") if !$game_map.isOverMap
$story_stats["sex_record_baby_birth"] +=1
if $game_player.actor.baby_race == "Deepone"
	$story_stats["sex_record_birth_Deepone"] += 1
	$game_party.gain_item($data_items[80], 1) #PlayerDeeponeBaby
else
	$story_stats["sex_record_birth_Human"] += 1
	$game_party.gain_item($data_items[78], 1) #PlayerHumanBaby
end
