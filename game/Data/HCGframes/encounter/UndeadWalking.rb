...
$story_stats["HiddenOPT4"] = "1"
$story_stats["HiddenOPT5"] = "1"
loop_is_over = 0
sneak_result = overmap_event_sneak_check(30,false)
call_msg("OvermapEvents:World/ThingHappen_begin")
SndLib.sound_UndeadSurprise(100)
chcg_background_color(0,0,0,255,-15) if @chcg_background_color
call_msg("OvermapEvents:World/ThingHappen_who_bad_UndeadWalking")
...
tmpOptions_Hide_able= true
	until loop_is_over ==1
		SndLib.sound_UndeadSkill(100)
		cocona_in_group? ? tmpOptions_Cocona = true : tmpOptions_Cocona = false
		...
		tmpPicked = ""
		tmpQuestList = []
		tmpQuestList << [$game_text["OvermapEvents:Lona/Options_Cocona"]		,"Options_Cocona"]			 if tmpOptions_Cocona
		...
		case tmpPicked
			when "Options_Cocona"
					call_msg("CompCocona:Overmap/UndeadWalkingEnc1")
					call_msg("CompCocona:Overmap/UndeadWalkingEnc2")
					optain_item($data_items[134],rand(3)+1)
					call_msg("CompCocona:Overmap/UndeadWalkingEnc3")
					loop_is_over =1
			...
			when "Options_Leave"
					...
					sneak_result = overmap_event_sneak_check(10)
					$game_player.actor.sta -= 2
			...
			when "Options_Talk"
					...
					if overmap_event_wisdom_check(60) == 1
						...
						$game_player.actor.sta -= 2
						call_msg("OvermapEvents:World/ThingHappen_who_bad_UndeadWalking_ComBad")
					end
