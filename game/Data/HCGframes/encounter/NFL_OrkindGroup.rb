...
$story_stats["OverMapEvent_name"] = "_bad_OrkindCamp"
$story_stats["OverMapEvent_enemy"] = 1
$story_stats["StepStoryCount"] = 0
sneak_result = overmap_event_sneak_check(15,false)
call_msg("OvermapEvents:World/ThingHappen_begin")
SndLib.sound_goblin_spot(100)
chcg_background_color(0,0,0,255,-15) if @chcg_background_color
call_msg("OvermapEvents:World/ThingHappen_who_bad_OrkindCamp")
...
tmpOptions_Hide_able= true
	until loop_is_over ==1
		$story_stats["OverMapEvent_saw"] ==0 ? SndLib.sound_goblin_idle(100) : SndLib.sound_goblin_spot(100)
