...
$story_stats["OverMapEvent_name"] = "_bad_OrkindPlayGround"
...
SndLib.sound_OrcSpot(100)
chcg_background_color(0,0,0,255,-15) if @chcg_background_color
call_msg("OvermapEvents:World/ThingHappen_who_bad_OrkindPlayGround")
...
tmpOptions_Hide_able= true
	until loop_is_over ==1
		$story_stats["OverMapEvent_saw"] ==0 ? SndLib.sound_goblin_idle(100) : SndLib.sound_OrcSpot(100)
		...
		case tmpPicked
			when "Options_Escape"
					...
					if $game_player.record_companion_name_front == "CompOrkindSlayer"
						call_msg("commonComp:CompOrkindSlayer/OrkindGroup_run")
