...
$story_stats["OverMapEvent_name"] = "_Good_NoerMissionary"
...
call_msg("OvermapEvents:World/ThingHappen_who_good_NoerMissionary")
	...
	until loop_is_over ==1
		...
		case tmpPicked
			...
			when "Options_Observe"
					...
					call_msg("OvermapEvents:World/ThingHappen_who_unknow_NoerMissionary_CheckWin")
					
			when "Options_Talk"
					tmpOptions_Talk_able = false
					$story_stats["OverMapEvent_saw"] =1
					call_msg("OvermapEvents:World/ThingHappen_who_good_NoerMissionary_ComGood")
