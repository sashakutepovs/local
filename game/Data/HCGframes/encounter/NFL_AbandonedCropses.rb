...
call_msg("OvermapEvents:World/ThingHappen_who_unknow_AbandonedCropses")
		...
		case tmpPicked
			...
			when "Options_Approach"
					if $story_stats["OverMapEvent_enemy"] ==1
						...
						return overmap_random_event_trigger(hidden_event,true,"AbandonedCropses")
					else
						$story_stats["RegionMap_Background"] = "AbandonedCropses"
						enter_tag_map = 1
						loop_is_over =1
					end
