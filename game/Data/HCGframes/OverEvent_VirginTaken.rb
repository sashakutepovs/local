...
$game_player.actor.stat["EventTargetPart"] = "Torture" if $game_actors[1].state_stack(106) !=0
p "Playing HCGframe : #{$game_player.actor.stat["EventTargetPart"]} Playing OverEvent :VagTaken"
$game_portraits.lprt.hide


if $story_stats["dialog_vag_virgin"] ==1
$story_stats["dialog_vag_virgin"] =0
$game_player.actor.record_lona_title = "main_stats/title_secondhand"
$game_message.add("\\t[commonH:Lona/VirginTaken_begin]")
$game_map.interpreter.wait_for_message
$game_actors[1].add_state(37) #bleed vag
...
lona_mood "#{chcg_decider_basic_arousal}fuck_#{chcg_cumming_mood_decider}"
	...
	##################################################################################
$cg = TempCG.new(["event_VirginTaken"])
...
$game_message.add("\\t[commonH:Lona/vag_taken#{talk_style}0]")
$game_map.interpreter.wait_for_message
#############################################################CHCG FRAME PEE OFF##################################################################################
lona_mood "#{chcg_decider_basic_arousal}fuck_#{chcg_cumming_mood_decider}"
	#################################################################################
...
#message control
flash_screen(Color.new(255,0,0,200),8,false)
$game_message.add("\\t[commonH:Lona/vag_taken#{talk_style}1]")
$game_map.interpreter.wait_for_message
#############################################################CHCG FRAME PEE ON##################################################################################
lona_mood "#{chcg_decider_basic_arousal}fuck_#{chcg_cumming_mood_decider}"
	#################################################################################
...
#message control
flash_screen(Color.new(255,0,0,200),8,false)
$game_message.add("\\t[commonH:Lona/vag_taken#{talk_style}2]")
$game_map.interpreter.wait_for_message
#############################################################CHCG FRAME PEE OFF##################################################################################
lona_mood "#{chcg_decider_basic_arousal}fuck_#{chcg_cumming_mood_decider}"
	#################################################################################
...
#stats_batch7
#message control
$game_message.add("\\t[commonH:Lona/vag_taken#{talk_style}3]")
$game_map.interpreter.wait_for_message
#############################################################CHCG FRAME PEE ON##################################################################################
lona_mood "#{chcg_decider_basic_arousal}fuck_#{chcg_cumming_mood_decider}"
	#################################################################################
...
#stats_batch7
#message control
$game_message.add("\\t[commonH:Lona/vag_taken#{talk_style}4]")
$game_map.interpreter.wait_for_message
...
#########################################################################################################################################
$game_message.add("\\t[commonH:Lona/VirginTaken_end]")
$game_map.interpreter.wait_for_message
$cg.erase
end
