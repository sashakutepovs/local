...
################################################################
$game_player.actor.stat["EventVag"] ="Abomination_Birth0"
$game_player.actor.stat["vagopen"] =0
...
########################################################################frame 1###################################################################################################
$game_player.actor.stat["EventVag"] = "Abomination_Birth1"
...
$game_player.actor.stat["chcg_x"] = $game_player.actor.portrait.portrait.x
$game_player.actor.stat["chcg_y"] = $game_player.actor.portrait.portrait.y
$game_player.actor.stat["chcg_x"] = -57 ; $game_player.actor.stat["chcg_y"] = -214
$game_player.actor.portrait.portrait.x= $game_player.actor.stat["chcg_x"] 
$game_player.actor.portrait.portrait.y += $game_player.actor.stat["chcg_y"]
#message control
...
################################################################
$game_player.actor.stat["EventVag"] ="Abomination_Birth2"
$game_player.actor.stat["vagopen"] =1
$game_player.actor.stat["preg"] -=1 if $game_player.actor.stat["preg"] !=0 #preg
lona_mood "chcg4fuck_#{chcg_mood_decider}"
$game_player.actor.stat["chcg_x"] = $game_player.actor.portrait.portrait.x
$game_player.actor.stat["chcg_y"] = $game_player.actor.portrait.portrait.y
$game_player.actor.stat["chcg_x"] = -69 ; $game_player.actor.stat["chcg_y"] = -302
$game_player.actor.portrait.portrait.x= $game_player.actor.stat["chcg_x"] 
$game_player.actor.portrait.portrait.y += $game_player.actor.stat["chcg_y"]
#message control
$game_message.add("\\t[commonH:Lona/brith#{talk_style}#{rand(10)}]")
...
################################################################
$game_player.actor.stat["EventVag"] ="Abomination_Birth3"
$game_player.actor.stat["vagopen"] =1
$game_player.actor.stat["preg"] -=1 if $game_player.actor.stat["preg"] !=0 #preg
...
$game_player.actor.portrait.portrait.y += $game_player.actor.stat["chcg_y"]
#message control
SndLib.BreedlingAtk(100)
$game_message.add("...........")
$game_map.interpreter.wait_for_message
SndLib.BreedlingAtk(90)
$game_message.add("......")
$game_map.interpreter.wait_for_message
SndLib.BreedlingAtk(80)
$game_message.add("...")
$game_map.interpreter.wait_for_message
######################################################################
...
$game_party.gain_item($data_items[71], 1)
$game_map.reserve_summon_event("PlayerAbominationBaby") if !$game_map.isOverMap
$story_stats["sex_record_baby_birth"] +=1
$story_stats["sex_record_birth_Abomination"] +=1
