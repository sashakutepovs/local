...
load_script("Data/HCGframes/Command_Collect_Pee.rb") if $game_player.actor.urinary_level >=300
load_script("Data/HCGframes/Command_Collect_Poo.rb") if $game_player.actor.defecate_level >=300
chcg_background_color(0,0,0,255,-7)

Audio.se_stop

$game_message.add("\\t[commonCommands:Lona/Excretion_end]")
$game_map.interpreter.wait_for_message
