...
if cocona_in_group? && $story_stats["RecQuestCoconaBuryPapa"] ==0 && $game_party.has_item?($data_items[109])
	portrait_hide
	...
	call_msg("TagMapNoerCatacomb:Lona/CoconaPapa_Bury")
	portrait_hide
	chcg_background_color(0,0,0,0,7)
		portrait_off
		$story_stats["RecQuestCoconaBuryPapa"] = 1
		optain_lose_item($data_items[109],1)
