if ["DoomFortressR","DoomFortressInn","DoomFortressL"].include?($game_map.name)
	$story_stats["RecQuestGuideToDoomFort"] = 2
	call_msg("TagMapAbanHouse3:mec/Done1")
	optain_item($data_items[51],3)
	wait(30)
	optain_morality(2)
	wait(30)
	optain_exp(5000*2)
	call_msg("TagMapAbanHouse3:mec/Done2")
	...
	tmpQuestList << [$game_text["commonComp:Companion/Wait"]			,"Wait"]
			...
			call_msg("TagMapAbanHouse3:mec/CommonConvoyTarget#{rand(3)}",0,2,0)
