...
if get_character(0).switch1_id != 1 #&& $game_player.actor.morality_lona >=10
	...
	call_msg("commonNPC:Qgiver/ConvoyToHobo_begin1")
	call_msg("commonNPC:Qgiver/ConvoyToHobo_board")
	...
	if set_comp
		...
		$story_stats["RecQuestConvoyTarget"] = [10,20] #貧民窟 難民營
		tar = ["CompExtConvoyHoboF",
				"CompExtConvoyHoboM"]
		tarNpc= tar.sample
