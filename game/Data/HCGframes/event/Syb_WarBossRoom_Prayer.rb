...
$game_portraits.setLprt("OgreWarboss_BoneShield")
$game_portraits.lprt.shake
$game_player.actor.master.call_balloon(2)
SndLib.sound_OgreDed(50,100)
wait(90)
$game_portraits.lprt.hide
wait(60)
...
$game_player.actor.master.call_balloon(8)
wait(60)
call_msg("TagMapSyb_WarBossRoom:prayer/begin1")
...
tmpTarList << [$game_text["TagMapSyb_WarBossRoom:Warboss/rapeloop_OPT_Impale"]				,"Gameover"]
...
case tmpPicked
	...
	when "Gameover"
		$story_stats["Ending_MainCharacter"] = "Ending_MC_OrkindImpale"
