 ####本檔案的種族設定
	if rand(100) <75 then temp_Race 	= "Goblin" else temp_Race  = "Orkind" end
	chcg_set_all_race(temp_Race)
####本檔案的種族設定 END
...
#==========================================劇情FUCK區塊====================================
	...
	call_msg("TagMapRandOrkindCave:Lona/RapeLoopTorture") if $story_stats["RapeLoopTorture"] == 1
	chcg_set_all_race(temp_Race)
	load_script("Data/Batch/common_MCtorture_Begin_event.rb") if $story_stats["RapeLoopTorture"] == 1
	chcg_set_all_race(temp_Race)
	load_script("Data/Batch/common_MCtorture_FunBeaten_event.rb") if $story_stats["RapeLoopTorture"] == 1
	chcg_set_all_race(temp_Race)
...
portrait_off
SndLib.Breathing_Goblin(80,110)
SndLib.Breathing_Orc
...
tempTxtData = ["DataNpcName:group/OrkindCave"]
$story_stats.sex_record_vag(tempTxtData)
$story_stats.sex_record_anal(tempTxtData)
