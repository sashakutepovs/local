...
get_character(0).call_balloon(0)
	...
	call_msg("commonNPC:MaleHumanGangNpc/PplM_begin1#{npc_talk_style}")
	...
	case tmpPicked
		when "Barter"
			manual_barters("BanditCamp1GangPPL")
		...
		when "Prostitution"
			...
			if $game_player.actor.sexy > temp_vs1
				...
				play_sex_service_menu(get_character(0),0.6,nil)
				tmpReward = [
					"ItemApple",		"ItemBread",
