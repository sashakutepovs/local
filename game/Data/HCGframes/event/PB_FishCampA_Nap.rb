if [6,7].include?($story_stats["RecQuestAriseVillageFish"])
	do_ret = false
	no_more_until = nil
	until do_ret
		tmp_fucker_id = nil
...
elsif $game_player.actor.stat["SlaveBrand"] == 1 && check_enemy_survival?("FishPPL",false)
...
elsif $story_stats["RecQuestAriseVillageFish"] >= 2
	handleNap
