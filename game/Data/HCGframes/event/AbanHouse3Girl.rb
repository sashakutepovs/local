...
set_comp=false
call_msg("TagMapAbanHouse3:mec/Quprog_0")
call_msg("TagMapAbanHouse3:mec/Quprog_0_board")
call_msg("TagMapAbanHouse3:mec/Quprog_0_decide")
...
if set_comp
	...
	tmpEV.set_this_event_companion_ext("AbanHouse3CompExtConvoy",false,10+$game_date.dateAmt)
	$game_map.reserve_summon_event("AbanHouse3CompExtConvoy",tmpEV.x,tmpEV.y)
