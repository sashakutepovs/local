...
if get_character(0).summon_data == nil
 ...
 get_character(0).summon_data[:SexTradeble] = true
	...
	call_msg("commonNPC:GoblinRandomNpc/CommonGoblin_begin1_#{rand(3)}")
	...
	call_msg("commonNPC:GoblinRandomNpc/CommonGoblin_CommonNpcOpt",0,2,0)
	...
	when "Prostitution"
		...
		if $game_player.actor.weak > temp_vs1
			...
			play_sex_service_menu(get_character(0),0.5,nil,true)
