...
if !$game_player.actor.equips[0].nil? && $game_player.actor.equips[0].id == 10 #ItemMhSickle
...
EvLib.sum("ItemBanana",$game_player.x,$game_player.y)
if get_character(0).switch1_id <= 0
	...
	EvLib.sum("ChopedTreeSmall",get_character(0).x,get_character(0).y,tmpData)
end
