...
call_msg("CompElise:FishResearch1/NoerDockSP") if $game_player.record_companion_name_ext == "CompExtUniqueElise" && $story_stats["RecQuestElise"] == 7
$game_temp.choice = -1
tmpGotoTar = ""
tmpTarList = []
tmpTarList << [$game_text["commonNPC:commonNPC/Cancel"]				,"Cancel"]
tmpTarList << [$game_text["commonNPC:commonNPC/Barter"]				,"Barter"]
tmpTarList << [$game_text["DataItem:ToFishTownL/item_name"]			,"RecQuestElise7"] if $game_player.record_companion_name_ext == "CompExtUniqueElise" && $story_stats["RecQuestElise"] == 7
...
case tmpPicked
	...
	manual_barters("RelayEmp_NoerDock")
when "RecQuestElise7"
	...
	optain_item($data_items[285],1) #ToNoerDock
	wait(60)
