if ["PirateBane","PirateBaneInn"].include?($game_map.name)
	$story_stats["RecQuestSwampRdkQuest1"] = 1
	call_msg("TagMapSwampRDK1:mec/Done1")
	optain_item($data_items[51],1)
	wait(30)
	optain_morality(2)
	wait(30)
	optain_exp(3000*2)
	call_msg("TagMapSwampRDK1:mec/Done2")
	...
	tmpQuestList << [$game_text["commonComp:Companion/Wait"]			,"Wait"]
			...
			call_msg("TagMapSwampRDK1:mec/CommonConvoyTarget#{rand(3)}",0,2,0)
