...
if get_character(0).summon_data == nil
 ...
 get_character(0).summon_data[:SexTradeble] = true
	...
	call_msg("commonComp:CompArcher/begin")
	tmpGotoTar = ""
	tmpTarList = []
	...
	case tmpPicked
	when "TeamUp"
		call_msg("commonComp:CompArcher/CompData")
		...
		case $game_temp.choice
			...
			when 1
				if $game_player.player_slave?
					...
					get_character(0).set_this_event_companion_back(get_character(0).name,false,$game_date.dateAmt+4)
