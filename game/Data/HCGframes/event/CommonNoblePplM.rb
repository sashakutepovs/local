...
if get_character(0).summon_data == nil
 ...
 get_character(0).summon_data[:SexTradeble] = true
	...
	call_msg("commonNPC:MaleHumanNoerNpc/PplM_begin1#{npc_talk_style}")
	...
	case tmpPicked
		when "Barter"
			manual_barters("CommonNoblePplM")
		...
		when "Prostitution"
			...
			if $game_player.actor.sexy > temp_vs1
				...
				call_msg("TagMapBank:NapBank/talk0")
		...
		when "Begging"
				...
				temp_tar = 400+rand(400) ##############   Begging Diff
