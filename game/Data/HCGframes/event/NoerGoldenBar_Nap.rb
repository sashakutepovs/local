...
until do_ret
	...
	if tmp_fucker_id != nil && !$game_map.threat
		...
		call_msg("TagMapNoerGoldenBar:CommonPPL/NapRape")
		...
		get_character(tmp_fucker_id).turn_toward_character($game_player)
		call_msg("TagMapNoerGoldenBar:CommonPPL/NapRape1")
		call_msg("TagMapNoerGoldenBar:CommonPPL/NapRape2")
		...
		call_msg("TagMapNoerGoldenBar:CommonPPL/NapRape3")
		if $game_player.actor.sta > 0
			...
			case $game_temp.choice
				when 0
					...
					call_msg("TagMapNoerGoldenBar:CommonPPL/NapRape_withSta_NoFight2")
				when 1
					player_cancel_nap
					do_ret = true
					...
					get_character(tmp_fucker_id).call_balloon(20)
					call_msg("TagMapNoerGoldenBar:CommonPPL/NapRape_withSta_Fight2")
			end
