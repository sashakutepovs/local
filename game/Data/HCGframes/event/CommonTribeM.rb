...
if get_character(0).summon_data == nil
 ...
 get_character(0).summon_data[:SexTradeble] = true
	...
	call_msg("TagMapPenisTribe:Commoner/RngDialog#{rand(3)}")
	...
	case tmpPicked
		...
		when "Prostitution"
			...
			if $game_player.actor.sexy > temp_vs1
				...
				play_sex_service_menu(get_character(0),0.5,"closest")
				tmpReward = [
					"AnimalRoach",		"AnimalRattus",
					"ItemRawMeat",		"ItemFruitWine",
					"ItemBeer"
					]
