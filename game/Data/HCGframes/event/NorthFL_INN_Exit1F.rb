...
call_msg("TagMapNorthFL_INN:1fExit/Begin") #[算了,進入,隱匿進入<r=HiddenOPT1>,唬爛進入<r=HiddenOPT2>]
...
if tmp_pass ==1
	if $story_stats["Captured"] == 1
		change_map_tag_sub("NorthFL","StartPointInn",2,true,true,true)
	else
		change_map_tag_sub("NorthFL","StartPointInn",2,true,true,false)
	end
end
