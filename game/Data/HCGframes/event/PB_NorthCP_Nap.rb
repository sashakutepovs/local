if $story_stats["QuProgPB_NorthCP"] == 0
	do_ret = false
	no_more_until = nil
	until do_ret
		tmp_fucker_id = nil
...
$story_stats["OnRegionMapSpawnRace"] = "Orkind" if $story_stats["QuProgPB_NorthCP"] == 1
$story_stats["OnRegionMapSpawnRace"] = "UndeadWalking" if $story_stats["QuProgPB_NorthCP"] >= 2
$story_stats["RapeLoop"] = 1 if check_enemy_survival?(tmpRace=$story_stats["OnRegionMapSpawnRace"],tmpWrite=false)
