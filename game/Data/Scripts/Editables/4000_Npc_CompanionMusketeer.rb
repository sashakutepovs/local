...
#哥布林AI，走三部打一步
class Npc_CompanionMusketeer < Game_NonPlayerCharacter
	...
	def setup_npc
		...
		skills = ["NpcCurvedMusket","WoodenSpearNormal","NpcBasicSh"]
	...
	def move_sneak
		...
		@movement = :sneak
		@event.opacity = 175
		@stat.set_stat_m("move_speed",2.5,[0,2,3])
		...
		skills = ["NpcCompMusketeerSneakMusket","WoodenSpearNormal","NpcBasicSh"]
		@skills_killer_list=@skills_assaulter_list=skills
		clear_cached_skill
	...
	def move_normal
		...
		@movement = :normal
		@event.opacity = 255
		@stat.set_stat_m("move_speed",3.8,[0,2,3])
		@stat.set_stat("move_speed",@stat.get_stat("move_speed",ActorStat::MAX_STAT))
	...
	def get_move_command
		...
		tgt = get_target
		assemble = $game_player.check_companion_assemblyCall?
