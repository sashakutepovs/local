...
#標準型人類，發現目標就是衝過去狂扁
class Npc_UniqueGrayRat < Game_NonPlayerCharacter
	def update_frame
	...
	def get_move_command
		...
		tgt = get_target
		self.process_target_lost if !tgt.nil? && (@target == master || @fraction == tgt.actor.fraction || tgt.actor.npc_name == "UniqueCecily")
