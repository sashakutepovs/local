...
class Sprite_Base < Sprite
  ...
  #--------------------------------------------------------------------------
	...
	#According to RPGMaker Help Sprite.update can be skipped if flash or wave animation are not used which is precisely our case.
	def update
		#super
		update_animation
		@@ani_checker.clear
  ...
  def animation_set_sprites(frame)
    ...
    @ani_sprites.each_with_index do |sprite, i|
      ...
      sprite.z = System_Settings::MAP_BALLOON_Z
      sprite.ox = 96
      sprite.oy = 96
