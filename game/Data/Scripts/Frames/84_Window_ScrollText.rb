...
class Window_ScrollText < Window_Base
  ...
  #--------------------------------------------------------------------------
  def show_fast?
    !$game_message.scroll_no_fast && (Input.press?(:A) || Input.press?(:C) || WolfPad.trigger?(:X_LINK) || WolfPad.trigger?(:Z_LINK) || (Mouse.enable? && Input.trigger?(:MZ_LINK) || Input.trigger?(:MX_LINK)) )
  end
  #--------------------------------------------------------------------------
  # * End Message
  #--------------------------------------------------------------------------
