...
class Game_Message
  ...
  attr_accessor :choice_timeout_type	  # option choosed when timeout
  attr_accessor :timeout				  # timeout時間
  attr_accessor :preserved_message		  # 要前往的目標節點
  attr_accessor :narrator				  # 敘事模式
  #--------------------------------------------------------------------------
