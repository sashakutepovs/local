  #if !$game_message.busy? && !$game_map.interpreter.running? 
#==============================================================================
...
module MOG_ACTIVE_TIMER
    ...
    #HUD_Z = 50 # to System_Settings::TIMER_ON_FIRE_Z
end  
...
class Sprite_Timer < Sprite
  ...
  def create_layout
      ...
      @layout.z = System_Settings::TIMER_ON_FIRE_Z
  ...
  def create_meter
      ...
      @meter_sprite.z = 1 + System_Settings::TIMER_ON_FIRE_Z
  ...
  def create_number
      ...
      @number_sprite.z = 3 + System_Settings::TIMER_ON_FIRE_Z
  ...
  def create_fire
      ...
      @fire_sprite.z = 2 + System_Settings::TIMER_ON_FIRE_Z
  ...
  #--------------------------------------------------------------------------  
		def update
			super
			update_visible
			update_effect if $game_timer.working?
		end
		def update_effect
			update_timer
			update_flow
