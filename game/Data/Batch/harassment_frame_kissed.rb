...
$game_actors[1].arousal += rand(6) * 10 if $game_player.actor.stat["AsVulva_Esophageal"] ==1 #魔紋：食道性器化
$game_actors[1].arousal += rand(30)+(rand(5) * $game_actors[1].sensitivity_mouth) #B敏感
