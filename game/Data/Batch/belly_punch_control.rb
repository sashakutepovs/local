...
$game_player.actor.arousal += rand(50) if $game_player.actor.stat["Masochist"] ==1
	#$game_actors[1].sta += 10+rand(5)
$game_player.actor.health -= $game_player.actor.subtraction_health(5+rand(10))
$game_player.actor.baby_health -= 10+rand(11) if $game_player.actor.preg_level !=0
...
$game_player.actor.baby_health -= 6+rand(11) if $game_player.actor.preg_level !=0 && $story_stats["Setup_Hardcore"] >= 1
