...
$game_actors[1].arousal += rand(50) if $game_actors[1].state_stack(102) ==1 #精液中毒
...
$game_actors[1].semen_addiction_damage +=rand(37)
$game_actors[1].semen_addiction_level -=rand(74)
