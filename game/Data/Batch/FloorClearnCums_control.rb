...
$game_actors[1].mood -= (rand(3)+3) if $game_player.actor.stat["Prostitute"] ==0 #change to -mood
$game_actors[1].mood -= (rand(3)+8) if $game_player.actor.stat["IronWill"] ==1 #change to -mood
#Global.good_happen  if aggrement sex
$game_actors[1].mood += (rand(3)+2) if $game_player.actor.stat["Nymph"] ==1 #change to +mood
$game_actors[1].mood += (rand(8)+3) if $game_player.actor.stat["Masochist"] ==1 #change to +mood
tmpSight = true
#------------------------------------------------------------- #每FRAME EXP 接收
tmpBouns = 1
...
$game_actors[1].semen_addiction_damage +=rand(50)
$game_actors[1].semen_addiction_level -=rand(100)
#$game_actors[1].puke_value_normal += rand(10)
$game_actors[1].addCums("CumsMouth",75,"Human")
#$game_actors[1].health -= rand(2) if $game_player.actor.stat["WeakSoul"] ==0
#$game_actors[1].health -= rand(2)
SndLib.sound_drink(100)
SndLib.sound_chcg_chupa(80,90)
