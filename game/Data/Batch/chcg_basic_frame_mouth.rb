...
$game_actors[1].arousal += rand(5) * $game_actors[1].sensitivity_mouth #mouth_sensitivity
$game_actors[1].arousal += rand(25) if $game_player.actor.stat["Nymph"] ==1
$game_actors[1].arousal += rand(25) if $game_player.actor.stat["Masochist"] ==1
$game_actors[1].arousal += rand(25) if $game_player.actor.stat["AsVulva_Esophageal"] ==1
$game_actors[1].arousal += (10*$game_player.actor.stat["FeelsHorniness"]) # feels hot
$game_actors[1].arousal += 10 if $game_player.actor.stat["FeelsWarm"] ==1 # feels warm
$game_actors[1].sta -= 1+rand(2)
$game_actors[1].sta -= 1+rand(2) if $game_player.actor.stat["WeakSoul"] ==0
$game_actors[1].urinary_level += rand(3)
$game_actors[1].semen_addiction_damage +=rand(30)
$game_actors[1].semen_addiction_level -=rand(60)
...
$game_actors[1].health -= rand(2) if $game_player.actor.stat["WeakSoul"] ==0 && $story_stats["Setup_Hardcore"] >= 1
$game_actors[1].health -= rand(2) if $story_stats["Setup_Hardcore"] >= 1
