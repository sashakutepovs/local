...
$game_actors[1].mood -= (rand(5)+10) if $game_player.actor.stat["IronWill"] ==1 #change to -mood
#Global.good_happen  if aggrement sex
$game_actors[1].mood += (rand(5)+10) if $game_player.actor.stat["Masochist"] ==1 #change to +mood
tmpSight = true
#------------------------------------------------------------- #每FRAME EXP 接收
tmpBouns = 1
...
$game_actors[1].anal_damage += rand(700)
$game_actors[1].defecate_level += rand(100)
$game_actors[1].health -= 3+rand(4) if $story_stats["sex_record_anal_dilatation"].between?(0,14) && $game_player.actor.stat["SphincterDamaged"] < 1
...
SndLib.sound_chs_buchu(100,rand(50)+50)
