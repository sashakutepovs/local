...
$game_actors[1].arousal += rand(25) + (3*$game_actors[1].sensitivity_vag) #vag_sensitivity
...
$game_actors[1].baby_health -= 1+rand(3) if $game_actors[1].preg_level !=0
...
$game_actors[1].baby_health -= rand(2) if $game_actors[1].preg_level !=0 && $story_stats["Setup_Hardcore"] >= 1
