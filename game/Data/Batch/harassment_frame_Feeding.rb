...
$game_actors[1].arousal += rand(30)+(rand(3) * $game_actors[1].sensitivity_breast) #B敏感
...
$game_actors[1].lactation_level += 6*$game_player.actor.stat["Lactation"] + ($game_player.actor.stat["Mod_MilkGland"]*10) #STATE增加乳汁
